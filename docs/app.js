...
const signatureData = `<table border="0" cellpadding="0" cellspacing="0" class="wavin-signature" style="width: 100%;" width="100%"> <tbody> <tr> <td style="font-family: 'Lato', sans-serif;"> <table border="0" cellpadding="0" cellspacing="0" class="height-100 logo-person-container" style="margin-bottom: 12px; height: 100%;" height="100%"> <tbody class="height-100" style="height: 100%;"> <tr class="height-100" style="height: 100%;"> <td style="font-family: 'Lato', sans-serif;"> <img src="wavin-logo-emailfooter.png" alt="" class="logo-word" style="width: 115px; position: relative; left: 0;" width="100"> </td><td class="height-100" style="font-family: 'Lato', sans-serif; height: 100%;" height="100%"><div class="logo-divider" style="font-family: 'Lato', sans-serif; width: 2px; height: 100%; background-color: #76b72a; margin: 0 10px; border-radius: 2px;"></div></td><td style="font-family: 'Lato', sans-serif;"> <p class="person-name" style="font-family: 'Lato', sans-serif; margin: 0; font-size: 1.3rem; font-weight: 400; color: #000000;">{{full-name}}</p><p class="person-title" style="font-family: 'Lato', sans-serif; margin: 0; font-size: 1rem; font-weight: 600; color: #76b72a;">{{job-title}}<span class="person-company" style="font-size: 1rem; font-weight: 500; color: rgb(87, 87, 87);">,<br>Wavin Technologies Pty Limited</span></p></td></tr></tbody> </table> </td></tr><tr> <td style="font-family: 'Lato', sans-serif;"> <table border="0" cellpadding="0" cellspacing="0" class=""> <tr> <td style="font-family: 'Lato', sans-serif;"> <table border="0" cellpadding="0" cellspacing="0" class=""> <tr> <td style="font-family: 'Lato', sans-serif;"> <p class="contact-text" style="font-family: 'Lato', sans-serif; margin: 0; font-size: 0.97rem; color: rgb(87, 87, 87); margin-bottom: 4px;"> <span class="contact-hint" style="font-weight: 600; margin-right: 4px; color: rgb(58, 58, 58);">M:</span> <a href="tel:{{mobile-e164}}" style="font-family: 'Lato', sans-serif; color: #76b72a; font-weight: 700;">{{mobile}}</a><span class="contact-spacer" style="font-weight: 500; color: inherit; margin: 0 9px;">|</span><span class="contact-hint" style="font-weight: 600; margin-right: 4px; color: rgb(58, 58, 58);">E:</span> <a href="mailto:{{email}}" style="font-family: 'Lato', sans-serif; color: #76b72a; font-weight: 700;">{{email}}</a> </p></td></tr><tr> <td style="font-family: 'Lato', sans-serif;"> <p class="contact-text" style="font-family: 'Lato', sans-serif; margin: 0; font-size: 0.97rem; color: rgb(87, 87, 87); margin-bottom: 4px;"> <span class="contact-hint" style="font-weight: 600; margin-right: 4px; color: rgb(58, 58, 58);">W:</span> <a href="http://www.getwavin.com" style="font-family: 'Lato', sans-serif; color: #76b72a; font-weight: 700;">www.getwavin.com</a> </p></td></tr></table> </td></tr><tr> <td style="font-family: 'Lato', sans-serif;"> <p class="branding-tag" style="font-family: 'Lato', sans-serif; margin: 0; font-size: 0.94rem; color: rgb(58, 58, 58); margin-bottom: 6px;">Don't Just Login. <b>Wavin™</b></p></td></tr></table></td></tr></tbody></table> <tr> <td style="font-family: 'Lato', sans-serif;"> <div class="hr-spacer" style="font-family: 'Lato', sans-serif; width: 200px; height: 60px; margin: 14px 0; border-radius: 60% 0 0 0; border-left: 3px solid #76b72a; border-top: 3px solid #76b72a; position: relative; left: -10px; display: none;"></div></td></tr><tr> <td style="font-family: 'Lato', sans-serif;"> <table border="0" cellpadding="0" cellspacing="0" class="footer-container" style="margin-top: 18px;"> <tbody> <tr> <td style="font-family: 'Lato', sans-serif;"><p class="wave-emoji" style="font-family: 'Lato', sans-serif; margin: 0; font-size: 1.4rem; margin-right: 6px;">&#128075;</p></td><td style="font-family: 'Lato', sans-serif;"><div class="footer-divider" style="font-family: 'Lato', sans-serif; width: 2px; height: 32px; background-color: #76b72a; margin: 0 10px; border-radius: 2px;"></div></td><td style="font-family: 'Lato', sans-serif;"><p class="footer-text" style="font-family: 'Lato', sans-serif; margin: 0; font-size: 0.92rem;">Keep your customers, suppliers and patrons safe in a COVID-19 normal world using Wavin™'s patented technology. <span class="contact-text" style="font-size: 0.97rem; color: rgb(87, 87, 87); margin-bottom: 4px;"><a href="http://www.getwavin.com" style="font-family: 'Lato', sans-serif; color: #76b72a; font-weight: 700;">Learn How.</a></span></p></td></tr><tr style="display: none;"> <td style="font-family: 'Lato', sans-serif;"></td><td style="font-family: 'Lato', sans-serif;"> <p class="footer-text-sm" style="font-family: 'Lato', sans-serif; font-size: 0.90rem; color: rgb(58, 58, 58); margin: 6px 0;">ACN: 642734503 – &copy;2020 Wavin Technologies Pty Limited</p></td></tr></tbody> </table> </td></tr><tr> <td style="font-family: 'Lato', sans-serif;"> <table border="0" cellpadding="0" cellspacing="0" class="compliance-container" style="margin-top: 18px;"> <tbody> <tr> <td style="font-family: 'Lato', sans-serif;"> <p class="compliance-text" style="font-family: 'Lato', sans-serif; font-size: 0.8rem; color: rgb(58, 58, 58); margin: 0 0 2px 0;">ACN: 642734503 – &copy;2020 Wavin Technologies Pty Limited</p></td></tr><tr> <td style="font-family: 'Lato', sans-serif;"> <p class="compliance-text" style="font-family: 'Lato', sans-serif; font-size: 0.8rem; color: rgb(58, 58, 58); margin: 0 0 2px 0;">Consider the environment before printing.</p></td></tr></tbody> </table> </td></tr><style>@media screen and (min-width: 480px){.logo-word{width: 160px;}}</style>`;
